...
- Raspberry Pi에서 C1 실행, 약 10 Hz `/scan`: 검증됨
- OpenCR USB 패스스루 펌웨어: 업로드 완료
- ver6 모터 맵: ID 1~19 반영 완료, ID 19 회전 방향은 실물 저속 확인 필요
- 실제 모터 자율주행: 미검증
...
`bike_teleop.py`는 이름과 달리 현재 8단계 ver6 바이크 변신 궤적을 한 번 발행하는
